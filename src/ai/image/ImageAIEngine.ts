...
export class ImageAIEngine {
  ...
  /**
   * 1. AI Background Removal (RMBG / Google MediaPipe Segmenter + Edge Matting)
   */
  ...
  /**
   * 2. AI Super-Resolution Upscaling (2x or 4x scale with tiling)
   */
  ...
  /**
   * 3. AI Face Restoration & Enhancement (Google MediaPipe BlazeFace + High-Frequency Restore)
   */
  ...
  public async preloadModel(
    ...
    switch (taskType) {
      ...
      case "upscale":
        await this.modelManager.getModelBinary(
          OFFICIAL_MODEL_MANIFESTS["real-esrgan-compact"],
          onProgress
        );
        break;
    }
