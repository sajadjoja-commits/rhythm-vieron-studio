...
export type TransitionType = "none" | "fade" | "slide" | "zoom" | "wipe" | "blur" | "dissolve" | "glitch" | "spin" | "flash" | "shutter" | "iris" | "split" | "mosaic" | "ripple" | "radar" | "whip-pan" | "zoom-blur" | "glitch-slice" | "page-flip" | "gsap-elastic-zoom" | "gsap-3d-flip" | "gsap-stagger-wipe" | "gsap-elastic-bounce";
...
export type VfxType = "glitch" | "shake" | "flash" | "zoom-pulse" | "rgb-split" | "vhs" | "scan-lines" | "pixelate" | "rotate-3d" | "particles" | "light-leak" | "film-grain" | "chromatic" | "shake-v" | "bounce" | "swing" | "heartbeat" | "prism" | "crt-scanner" | "radial-lens-flare" | "motion-blur-streak" | "vintage-sepia-bloom" | "water-ripple" | "vintage-8mm" | "old-vhs-tape" | "retro-sepia-grain" | "crt-tv-retro";
...
const extractVideoFrameThumbnail = (file: File): Promise<string> =>
  new Promise((resolve) => {
    const video = document.createElement("video");
    video.preload = "auto";
    video.muted = true;
    ...
    video.onloadeddata = () => {
      try { video.currentTime = Math.min(0.5, (video.duration || 1) / 2); } catch { resolve(""); }
    };
  ...
  return (
    <MediaContext.Provider
      value={{
        ...
        setExportPreset, setProjectName, newProject, loadProject, listProjects, deleteProject,
