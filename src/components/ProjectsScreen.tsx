    ...
    <div className="min-h-screen pb-28 px-4 pt-6 select-none max-w-7xl mx-auto" dir={en ? "ltr" : "rtl"}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {!showTrash && (
            <button
              onClick={onNew}
              className="flex items-center gap-2 px-4 py-2 rounded-xl gradient-primary glow-primary-sm text-primary-foreground text-xs font-extrabold shadow-md hover:scale-[1.02] active:scale-95 transition-all"
            >
      ...
      {showTrash ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <button
            onClick={onNew}
            className="flex items-center gap-2 px-5 py-2.5 rounded-2xl gradient-primary text-primary-foreground text-xs font-bold shadow-lg hover:scale-105 transition-all"
          >
            <Plus className="w-4 h-4" />
