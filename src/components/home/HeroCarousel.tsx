...
const SLIDES: BannerSlide[] = [
  ...
  },
  {
    ...
    badgeEn: "SUPER RESOLUTION",
    badgeAr: "دقة فائقة 8K",
    titleEn: "Enhance Photo Quality",
    titleAr: "تحسين جودة الصور حتى 8K",
    descEn: "AI Upscale, restore clarity, sharpen details, and remove noise",
    descAr: "تكبير الصور واستعادة تفاصيل الملامح وإزالة الضوضاء تلقائياً",
    ctaEn: "Enhance Photo",
    ctaAr: "تحسين صورة",
      ...
      <div className="relative p-5 sm:p-6 flex flex-col justify-between min-h-[225px] z-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-2 border-t border-white/15">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {/* Create Project Button (زر إنشاء مشروع) -> Opens Studio Media Picker */}
            <MediaPicker
              accept="both"
              multiple={true}
              onBeforePick={newProject}
