        ...
        {visibleTools.map((tool) => {
          ...
          if (tool.targetTab === "editor") {
            return (
              <MediaPicker
                ...
                className="group relative flex items-start gap-3 p-3.5 rounded-2xl bg-card border border-border/80 hover:border-primary/50 hover:shadow-lg transition-all text-start active:scale-[0.98] overflow-hidden animate-fade-in cursor-pointer w-full"
              >
                {content}
              </MediaPicker>
            );
          ...
          return (
            <button
              ...
              className="group relative flex items-start gap-3 p-3.5 rounded-2xl bg-card border border-border/80 hover:border-primary/50 hover:shadow-lg transition-all text-start active:scale-[0.98] overflow-hidden animate-fade-in cursor-pointer"
            >
              {content}
            </button>
          );
