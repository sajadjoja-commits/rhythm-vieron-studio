...
export const AI_STUDIO_TOOLS: AIToolConfig[] = [
  ...
  // --- AI AUDIO TOOLS ---
  {
    ...
    taskType: "enhance-media",
    nameAr: "تنقية وعزل الصوت (Adaptive Audio Enhance)",
    nameEn: "Adaptive Audio Enhance (Spectral Denoise & Splitter)",
    descAr: "تنقية ضوضاء الخلفية، إزالة الصدى، وتحسين نقاء الأصوات والكلام البشري",
    descEn: "Adaptive spectral background denoise, hum removal & vocal clarity",
    icon: Volume2,
    color: "#10b981",
