      ...
      try {
        ...
        if (hasNewAssets) {
          ...
          addDynamicNotification({
            id: `update-lovable-${freshAssets.join("-").slice(-20)}`,
            title: ar ? "تحديث جديد متوفر للتطبيق ⬥" : "New App Update Available ⬥",
            body: ar 
              ? "لقد قمنا بنشر تحديث جديد للتطبيق على Lovable يتضمن تحسينات وميزات إضافية. اضغط هنا للتحديث فوراً." 
              : "We have published a new update on Lovable with improvements and new features. Click to update now.",
