...
export const AIToolsPanel = ({
  ...
  const handleRunTool = async (toolConfig: AIToolConfig) => {
    ...
    const payload: Record<string, any> = {
      ...
      imageBase64OrUrl: mediaInput,
      videoBase64OrUrl: mediaInput,
      audioBase64OrUrl: mediaInput,
    };
