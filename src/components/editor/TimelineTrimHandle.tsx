  ...
  return (
    <div
      ...
      className={`${posClass} w-4 h-full cursor-ew-resize z-30 flex flex-shrink-0 items-center justify-center touch-none select-none transition-all duration-150 group ${
        isMaxReached
          ? "bg-gradient-to-b from-red-500 to-rose-700 shadow-[0_0_12px_rgba(239,68,68,0.9)] border-red-300"
    ...
    >
      ...
      <div className="absolute inset-0 bg-white/20 opacity-0 group-active:opacity-100 transition-opacity rounded-[inherit] pointer-events-none" />
    </div>
  );
};
