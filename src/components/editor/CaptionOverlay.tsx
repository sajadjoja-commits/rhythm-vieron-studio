              ...
              {editingId === active.id ? (
                ...
                <div
                  ...
                  style={{
                    ...
                    color,
                    background: bg,
                    padding: active.bgPadding ? `${active.bgPadding}px ${active.bgPadding * 2}px` : "4px 12px",
                    borderRadius: active.bgRadius !== undefined ? active.bgRadius : 8,
                    whiteSpace: active.isMultiLine ? "pre-wrap" : "nowrap",
                    maxWidth: active.isMultiLine ? "75vw" : "none",
                    textAlign: "center",
                    lineHeight: active.lineHeight || 1.3,
                    letterSpacing: active.letterSpacing ? `${active.letterSpacing}px` : undefined,
                    textTransform: active.textTransform || "none",
                    cursor: "grab",
                    touchAction: "none",
                    userSelect: "none",
                    boxShadow: isSelected ? "0 4px 20px rgba(var(--primary-rgb),0.5)" : "0 2px 12px rgba(0,0,0,0.35)",
                    textShadow: active.shadowColor
                      ? `${active.shadowOffsetX || 0}px ${active.shadowOffsetY || 2}px ${active.shadowBlur || 4}px ${active.shadowColor}`
                      : "0 2px 4px rgba(0,0,0,0.8)",
                    WebkitTextStroke: active.strokeWidth ? `${active.strokeWidth}px ${active.strokeColor || "#000"}` : undefined,
                  }}
                ...
                >
                  {renderBadgeIcon(active.badgeIcon)}
