...
const TRANSITIONS: { type: TransitionType; labelKey: string; emoji: string; color: string }[] = [
  ...
  { type: "gsap-elastic-zoom", labelKey: "transition.gsapElasticZoom", emoji: "🚀", color: "#3b82f6" },
  { type: "gsap-3d-flip", labelKey: "transition.gsap3DFlip", emoji: "💎", color: "#8b5cf6" },
  { type: "gsap-stagger-wipe", labelKey: "transition.gsapStaggerWipe", emoji: "🪄", color: "#ec4899" },
  { type: "gsap-elastic-bounce", labelKey: "transition.gsapElasticBounce", emoji: "⚡", color: "#10b981" },
