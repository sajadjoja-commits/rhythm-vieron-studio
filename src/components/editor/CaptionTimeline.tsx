...
const CaptionTimeline = memo(({ currentTime, pxPerSec, containerW, isPlaying, focused, onSeek, onAddClick, onFocus }: Props) => {
...
CaptionTimeline.displayName = "CaptionTimeline";
