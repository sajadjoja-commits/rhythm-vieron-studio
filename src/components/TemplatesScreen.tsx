...
import { BUILTIN_TRACKS } from "@/lib/builtinMusic";
import { fetchPublishedTemplates, generateTemplateShareUrl } from "@/services/templateService";
...
const TemplatePromoCard = ({ tpl, onClick, en }: { tpl: SmartTemplate; onClick: () => void; en: boolean }) => {
    ...
    try {
      ...
      if (musicType !== "none") {
        if (musicType === "custom-device" && musicFile) {
          ...
          const track = BUILTIN_TRACKS.find((t) => t.id === musicType);
          if (track) {
            addAudioTrack({
                  ...
                  <div className="p-3.5 space-y-2 flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-border mt-3">
                      <button
                        ...
                        className="flex-1 py-2 rounded-xl gradient-primary text-primary-foreground font-bold text-xs flex items-center justify-center gap-1.5 shadow-sm"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-secondary hover:bg-secondary/80 text-foreground border border-border"
